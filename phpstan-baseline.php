...
$ignoreErrors[] = [
    ...
    'identifier' => 'empty.notAllowed',
    'count' => 3,
    'path' => __DIR__ . '/src/Core/Framework/DataAbstractionLayer/Dbal/EntityDefinitionQueryHelper.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Construct empty() is not allowed. Use more strict comparison.',
    'identifier' => 'empty.notAllowed',
...
$ignoreErrors[] = [
    ...
    'identifier' => 'empty.notAllowed',
    'count' => 3,
    'path' => __DIR__ . '/src/Core/Framework/DataAbstractionLayer/Doctrine/FetchModeHelper.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Throwing new exceptions within classes are not allowed. Please use domain exception pattern. See https://github.com/shopware/platform/blob/v6.4.20.0/adr/2022-02-24-domain-exceptions.md',
    'identifier' => 'shopware.domainException',
...
$ignoreErrors[] = [
    'rawMessage' => 'Method Shopware\\Core\\Framework\\DataAbstractionLayer\\Field\\CreatedByField::__construct() has parameter $allowedWriteScopes with no value type specified in iterable type array.',
    'identifier' => 'missingType.iterableValue',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Framework/DataAbstractionLayer/Field/CreatedByField.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Method Shopware\\Core\\Framework\\DataAbstractionLayer\\Field\\CreatedByField::getAllowedWriteScopes() return type has no value type specified in iterable type array.',
    'identifier' => 'missingType.iterableValue',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Framework/DataAbstractionLayer/Field/CreatedByField.php',
];
...
$ignoreErrors[] = [
    'rawMessage' => 'Method Shopware\\Core\\Framework\\DataAbstractionLayer\\Field\\UpdatedByField::__construct() has parameter $allowedWriteScopes with no value type specified in iterable type array.',
    'identifier' => 'missingType.iterableValue',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Framework/DataAbstractionLayer/Field/UpdatedByField.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Method Shopware\\Core\\Framework\\DataAbstractionLayer\\Field\\UpdatedByField::getAllowedWriteScopes() return type has no value type specified in iterable type array.',
    'identifier' => 'missingType.iterableValue',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Framework/DataAbstractionLayer/Field/UpdatedByField.php',
];
